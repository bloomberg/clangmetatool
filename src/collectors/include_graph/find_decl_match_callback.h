#ifndef INCLUDED_FIND_DECL_MATCH_CALLBACK_H
#define INCLUDED_FIND_DECL_MATCH_CALLBACK_H
...
public:
  FindDeclMatchCallback(clang::CompilerInstance *ci, IncludeGraphData *d)
      : ci(ci), data(d) {}
