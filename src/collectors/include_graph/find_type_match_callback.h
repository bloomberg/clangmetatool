#ifndef INCLUDED_FIND_TYPE_MATCH_CALLBACK_H
#define INCLUDED_FIND_TYPE_MATCH_CALLBACK_H
...
public:
  explicit FindTypeMatchCallback(clang::CompilerInstance *ci,
                                 IncludeGraphData *d)
      : ci(ci), data(d) {}
