...
namespace clangmetatool {
  namespace collectors {
    namespace include_graph {
      ...
      static
      std::pair<FileUID, bool>
      get_fileuid(clang::CompilerInstance *ci,
        ...
        data->last_include.emplace
          (FileAttribute<clang::SourceLocation>(fuid,l));
      ...
      static FileUID
      resolve_include_next(clang::CompilerInstance *ci,
                           IncludeGraphData *data,
                           FileUID i) {
       ...
       const clang::Module *imported) {
        ...
        if (file && file->isValid()) {
          ...
          std::pair< FileAttributeMap<clang::SourceLocation>::iterator, bool >
            last_incl_empl =
            data->last_include.emplace(tuid.first, hashLoc);
      ...
      static
      std::pair<bool, std::pair<FileUID, FileUID> >
      resolve_file_graph_edge(clang::CompilerInstance *ci,
                              IncludeGraphData* data,
      ...
      static void
      add_usage(clang::CompilerInstance *ci,
                IncludeGraphData* data,
                clang::SourceLocation caller,
                clang::SourceLocation callee,
                ELEMENT &e,
      ...
      void add_redeclaration(clang::CompilerInstance *ci,
        ...
        add_usage( ci, data,
                   n->getLocation(), decl->getLocation(),
                   n, data->redeclarations );
      ...
      void add_decl_reference(clang::CompilerInstance *ci,
        ...
        add_usage( ci, data,
                   locUse, locDef,
                   e, data->decl_references );

      }

      template <typename T>
      static clang::Decl*
      extract_decl_for_type(const clang::Type* t) {
      ...
      void add_type_reference(clang::CompilerInstance *ci,
        ...
        add_usage(ci, data,
                  n->getBeginLoc(), decl->getLocation(),
                  n, data->type_references );
