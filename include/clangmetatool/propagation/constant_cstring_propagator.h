#ifndef INCLUDED_CLANGMETATOOL_PROPAGATION_CONSTANT_CSTRING_PROPAGATOR_H
#define INCLUDED_CLANGMETATOOL_PROPAGATION_CONSTANT_CSTRING_PROPAGATOR_H
...
/**
 * ConstantCStringPropagator is a tool to run a propagation
...
public:
  ...
  /**
   * Given the surrounding function and the usage of a char*
