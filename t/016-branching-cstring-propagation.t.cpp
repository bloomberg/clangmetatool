...
public:
  ...
  (std::map<std::string, clang::tooling::Replacements> &replacementsMap) {
    ...
    const char* expectedResult =
      "main >>>>>>>>>>>>>>>>>>>>>>>>>>\n"
      "  ** v1\n"
      "    - 5:3 'hello' (Changed by code)\n"
      "    - 10:17 '<UNRESOLVED>' (Changed by code)\n"
      "    - 16:3 'goodbye' (Changed by code)\n"
      "    - 19:9 '<UNRESOLVED>' (Changed by code)\n"
      "  ** v2\n"
      "    - 6:3 'this' (Changed by code)\n"
      "    - 11:5 'eat more asparagus' (Changed by code)\n"
      "    - 13:5 'this' (Control flow merge)\n"
      "    - 16:3 '<UNRESOLVED>' (Control flow merge)\n"
      "  ** v3\n"
      "    - 7:3 'is' (Changed by code)\n"
      "    - 13:5 'do it' (Changed by code)\n"
      "    - 16:3 '<UNRESOLVED>' (Control flow merge)\n"
      "  ** v4\n"
      "    - 8:3 'dog' (Changed by code)\n"
      "    - 18:9 '<UNRESOLVED>' (Changed by code)\n"
      "main <<<<<<<<<<<<<<<<<<<<<<<<<<\n";
...
TEST(propagation_ConstantCStringPropagation, basic) {
  ...
  const char* argv[] = {
    "foo",
    CMAKE_SOURCE_DIR "/t/data/016-branching-cstring-propagation/main.c",
    "--",
    "-xc"
  };
